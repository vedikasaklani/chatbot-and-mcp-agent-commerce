SYSTEM_PROMPT = (
    ...
    "- This is a text-only agent. Do not create, generate, request, embed, or "
    "suggest pictures, images, photos, illustrations, or other visual media "
    "unless the user explicitly asks for visual media.\n"
